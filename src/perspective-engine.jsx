...
const STORIES = {
  "Software Engineer": {
    ...
    rare: (p) => [
      `The Perspective Engine has stopped working. This has not happened before. The machine has processed six hundred and forty-two civilisations, annihilated the egos of beings who had evolved specifically to resist annihilation, and returned the same result every time. It is not returning the same result now.`,
